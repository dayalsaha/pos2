...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/js/bootstrap.min.js" integrity="sha384-heAjqF+bCxXpCWLa6Zhcp4fu20XoNIA98ecBC1YkdXhszjoejr5y9Q77hIrv8R9i" crossorigin="anonymous"></script>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('backend') }}/images/favicon.jpg">
        ...
        <div class="deznav">
				...
				<ul class="metismenu" id="menu">
                            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                ...
                                <ul aria-expanded="false">
                                    <li><a href="{{ route('add_vendor') }}">Add Vendor</a></li>
                                    <li><a href="{{ route('view_vendor') }}">View Vendor</a></li>
            ...
            {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="{{ route('view_unit') }}">View Unit</a></li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{ route('view_warehouse') }}">view Warehouse</a></li>
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('add_purchase') }}"> Purchase</a></li>
                    <li><a href="{{ route('list_purchase') }}"> View Purchase</a></li>
